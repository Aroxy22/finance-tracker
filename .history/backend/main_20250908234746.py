...
print("Loading local Hugging Face model with PyTorch only...")
nlp = pipeline("text-generation", model="gpt2", framework="pt")  # ✅ Force PyTorch
# ----------------------------------------------------------
...
def ask_question(payload: dict):
    ...
    try:
        result = nlp(question, max_length=100, num_return_sequences=1)
        answer = result[0]["generated_text"]
        return JSONResponse({"status": "ok", "question": question, "answer": answer})
